...
export default class default1658087566800 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE `clients` (`id` int NOT NULL AUTO_INCREMENT, `name` text NOT NULL, `email` text NOT NULL, `balance` decimal NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB');
